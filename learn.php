...
array(2) { 
    ["select-language"]=> string(7) "espanol" 
    ["check-monday"]=> array(5) { 
        [0]=> string(6) "monday" 
        [1]=> string(4) "nine" 
        [2]=> string(6) "twelve" 
        [3]=> string(7) "fifteen" 
    ...
    array(4) { ["select-language"]=> string(7) "espanol" 
        ["check-monday"]=> array(2) { 
            [0]=> string(6) "monday" 
            [1]=> string(4) "nine" } 
        ["check-wednesday"]=> array(2) { 
            [0]=> string(9) "wednesday" 
            [1]=> string(6) "twelve" } 
        ["check-friday"]=> array(2) { 
            [0]=> string(6) "friday" 
            [1]=> string(7) "fifteen" } 
        } 
