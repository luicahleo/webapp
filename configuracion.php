        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <!-- Basic Form Wizard -->
                    <form id="basic-wizard" action="configuracion.php" method="post" class="form-horizontal form-box">
                        <!-- Form Header -->
                        <h4 class="form-box-header"><i class="fa fa-cog"></i> Configuracion</h4>
                        ...
                        <div class="form-box-content">
                            ...
                            <div id="first" class="step">
                                ...
                                <div class="wizard-steps row">
                                    <div class="col-md-4 text-center active">Cambiar contrasena</div>
                                </div>
                                <!-- END Step Info -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <input type="password" id="example-password" name="cambia_password" class="form-control">
                                            <span class="input-group-addon"><i class="fa fa-asterisk"></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="example-password2">Repite Password</label>
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <input type="password" id="example-password2" name="cambia_password2" class="form-control">
                                            <span class="input-group-addon"><i class="fa fa-asterisk"></i></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group form-actions">
                                <div class="col-md-10 col-md-offset-2">
                                    <input type="submit" class="btn btn-success" id="next" value="Cambiar">
                                </div>
                            </div>
                            <!-- END Form Buttons -->
                        </div>
                ...
                <!-- Footer -->
                <footer>
                    <span id="year-copy"></span> &copy; <strong><a href="https://1.envato.market/7jd">uAdmin 2.1</a></strong> - Crafted with <i class="fa fa-heart text-danger"></i> by <strong><a href="https://1.envato.market/ydb" target="_blank">pixelcave</a></strong>
                </footer>
                <!-- END Footer -->
            </div>
            <!-- END Inner Container -->
